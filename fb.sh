...
ku='\033[33;1m' #kuning
# [SUBSCRIBE] Arfan Al
figlet -f standard FBpace Tools | lolcat
echo
echo  " ____________________-=[Private Tools]=-____________________" | lolcat
echo  "|                                                           |" | lolcat
echo  "|             Root®Autor      : Mr.Ar05                     |" | lolcat
echo  "|             Youtube         : Arfan Al                    |" | lolcat
echo  "|             IG             : arfan_al78955                |" | lolcat
...
sleep 2
echo $ku"Youtube :"$i" Arfan Al"
echo $ku"Instagram :"$i" @arfan_al78955"
sleep 2
